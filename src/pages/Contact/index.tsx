...
const Contact = () => {
  const icons = [
    ...
    {
      link: "https://www.linkedin.com/in/aldi-m-alpaujan/",
      icon: "ic-linkedin",
    },
    {
  ...
  return (
    <PageWrapper
      id="Contact"
      className="h-screen pt-section flex items-center justify-center"
    >
      <div className="flex flex-col items-center justify-center">
        ...
        <p
          ...
          data-aos-duration="1000"
          data-aos-delay="400"
          className="font-inter max-w-2xl text-sm font-medium text-center text-light-body dark:text-dark-body
        md:text-base md:max-w-3xl lg:text-lg"
        >
          Ready to take the next step? Don't hesitate to reach out if you're
          looking for a developer, have questions, or want to share ideas. I
          would be happy to hear from you through the platforms below.
        </p>
          ...
          {icons.map((v, i) => (
            ...
            >
              <a href={v.link} target="_blank" className="flex items-center">
                <i
                  className={`${v.icon} text-3xl text-light-body dark:text-dark-body md:text-4xl 2xl:text-[40px]`}
                />
