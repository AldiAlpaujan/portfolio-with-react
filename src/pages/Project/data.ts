...
import myKBIHU from "../../assets/project/my-kbihu.png";
...
const projectData: ProjectModel[] = [
  ...
  },
  {
    ...
    title: "My Portfolio",
    description:
      "My web portfolio is a website I created to showcase my skills, expertise, and past projects, aimed at attracting potential clients.",
    tech: "React js, Typescript, Vite.",
    projectType: ProjectType.WEB,
    canTouch: true,
